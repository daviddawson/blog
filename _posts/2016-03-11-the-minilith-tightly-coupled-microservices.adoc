...
tags:
 - architecture
 - microservices
excerpt: Handling early Microservices deployments by locking deployments together. Enter the Minilith.
---
include::fromsi.adoc[]

Without a doubt, Microservices as an architecture has grasped the imagination of modern development like no other.

We've found that, contrary to what many will tell you, it defies http://www.simplicityitself.io/microservices%20and%20reactive/2015/06/16/defining-microservice-architecture.html[tight definition]. Specifying how microservices should interact with each other, how they should store and master data, and how they should be deployed is great for a conference talk, but the style has been adopted too broadly now to be prescriptively tied down by anyone. Opinions abound, and yet you will find **no** consensus in what microservices actually are beyond the use of some form of effective isolation, usually network based.
...
WIth that in mind, I sat down to read about and then watch a recent http://www.infoq.com/news/2016/02/services-distributed-monolith[talk by Ben Christensen]

I recommend you watch, it's an interesting take, and one worth analysing for yourself.

I've written on the perils of DRY http://www.simplicityitself.io/our%20team/2015/01/01/development-by-slogan-dry-part1.html[a] http://www.simplicityitself.io/our%20team/2015/01/08/development-by-slogan-dry-part2.html[fair] http://www.simplicityitself.io/our%20team/2015/01/09/development-by-slogan-dry-part3.html[amount], and so to a large extent I totally agree. Where I diverge from much of the discussion is on the principle of autonomy and runtime coupling. Here, I am certainly a huge proponent of generating autonomy between services. The more a service can orient itself and figure out what to do, the better.
...
I pinched this term from https://skillsmatter.com/legacy_profile/gawain-hammond[Gawain Hammond], currently of the Sky Tech Futures team.
